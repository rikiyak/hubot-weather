...
# Command:
#  > baa -> メェェ
#  > sheep weather <CITY_NAME>

request = require("request")

module.exports = (robot) ->

    unless process.env.HUBOT_OPEN_WEATHER_MAP_APP_TOKEN?
        robot.logger.warning 'Required HUBOT_OPEN_WEATHER_MAP_APP_TOKEN environment.'
        return

    robot.hear /baa/i, (msg) ->
        msg.send "メェェ"
